...
function getBrowserInfo() {
    var e, t = navigator.userAgent.toLocaleLowerCase(),
        n = null;
...
if ("sogou" != browserTypeReal) {
    ...
    try {
        var domains = regex.exec(document.location.href)[1],
    ...
    t.prototype = {
        ...
        sendData: function(e) {
            var c = this,
                o = function(e) {
                    function n(e) {
                        e = new RegExp("(^|&)" + e + "=([^&]*)(&|$)"), e = g.location.search.substr(1).match(e);
                    ...
                    function d() {
                        var e = {
                            ...
                            t = "getcdata.58.com/api/v1/pcm/getfp?";
                        console.log("getfp全参数", "https" + t + a(e));
                        t = CryptoJS.HmacSHA256("https" + t + a(e), "7F5B9632B2F13918"), t = CryptoJS.enc.Base64.stringify(t);
                        e.signature = t;
                    ...
                    function h(e) {
                        var t, n;
                        200 == e.code ? (e.data.split("")[0], e.data.split("")[1], t = e.data.split("")[2], n = e.data.split("")[3], console.log("xzuid_e", n), "sogou" == browserTypeReal ? ("" != t && c.hand_save_all("xxzl_cid", t), "" != n && c.hand_save_all("xzuid", n)) : ("" != t && _0xd7e6c.set("xxzl_cid", t), "" != n && _0xd7e6c.set("xzuid", n))) : setTimeout(function() {
                            r()
                    ...
                    function r() {
                        ...
                        o.appendChild(c), g[i] = function(e) {
                            e = CryptoJS.AES.decrypt(e, CryptoJS.enc.Utf8.parse("3279831EC33B4CA7"), {
                                mode: CryptoJS.mode.ECB,
                                padding: CryptoJS.pad.Pkcs7
                            }).toString(CryptoJS.enc.Utf8);
                            console.log("getfp返回结果5", e), "" != JSON.parse(e).data.split("")[1] && h(JSON.parse(e)), o.removeChild(p), g[i] = null
                        }, g[r] = function(e) {
                            e = CryptoJS.AES.decrypt(e, CryptoJS.enc.Utf8.parse("3279831EC33B4CA7"), {
                                mode: CryptoJS.mode.ECB,
                                padding: CryptoJS.pad.Pkcs7
                            }).toString(CryptoJS.enc.Utf8);
                            console.log("getfp返回结果4", e), "" == JSON.parse(e).data.split("")[1] ? setTimeout(function() {
                                o.removeChild(u), o.appendChild(p), p.src = domainConfig + "/api/v1/pcm/getfp?param=" + d() + "&callback=" + i
                            }, 3e3) : (h(JSON.parse(e)), o.removeChild(u)), g[r] = null
                        }, g[a] = function(e) {
                            e = CryptoJS.AES.decrypt(e, CryptoJS.enc.Utf8.parse("3279831EC33B4CA7"), {
                                mode: CryptoJS.mode.ECB,
                                padding: CryptoJS.pad.Pkcs7
                            }).toString(CryptoJS.enc.Utf8);
                            console.log("getfp返回结果3", e), "" == JSON.parse(e).data.split("")[1] ? setTimeout(function() {
                                o.removeChild(l), o.appendChild(u), u.src = domainConfig + "/api/v1/pcm/getfp?param=" + d() + "&callback=" + r
                            }, 3e3) : (h(JSON.parse(e)), o.removeChild(l)), g[a] = null
                        }, g[n] = function(e) {
                            e = CryptoJS.AES.decrypt(e, CryptoJS.enc.Utf8.parse("3279831EC33B4CA7"), {
                                mode: CryptoJS.mode.ECB,
                                padding: CryptoJS.pad.Pkcs7
                            }).toString(CryptoJS.enc.Utf8);
                            console.log("getfp返回结果2", e), "" == JSON.parse(e).data.split("")[1] ? setTimeout(function() {
                                o.removeChild(s), o.appendChild(l), l.src = domainConfig + "/api/v1/pcm/getfp?param=" + d() + "&callback=" + a
                            }, 3e3) : (h(JSON.parse(e)), o.removeChild(s)), g[n] = null
                        }, g[t] = function(e) {
                            e = CryptoJS.AES.decrypt(e, CryptoJS.enc.Utf8.parse("3279831EC33B4CA7"), {
                                mode: CryptoJS.mode.ECB,
                                padding: CryptoJS.pad.Pkcs7
                            }).toString(CryptoJS.enc.Utf8);
                            console.log("getfp返回结果1", e), "" == JSON.parse(e).data.split("")[1] ? setTimeout(function() {
                                o.removeChild(c), o.appendChild(s), s.src = domainConfig + "/api/v1/pcm/getfp?param=" + d() + "&callback=" + n
                            }, 3e3) : (h(JSON.parse(e)), o.removeChild(c)), g[t] = null
                    ...
                    console.log("report解密后", t);
                    var i, o = JSON.parse(t);
                    200 == o.code ? (o.data.split("")[0], i = o.data.split("")[1], e = o.data.split("")[2], t = o.data.split("")[3], console.log("xzuid_e", t), "sogou" == browserTypeReal ? ("" != e && c.hand_save_all("xxzl_cid", e), "" != t && c.hand_save_all("xzuid", t)) : ("" != e && _0xd7e6c.set("xxzl_cid", e), "" != t && _0xd7e6c.set("xzuid", t)), "" == i && setTimeout(function() {
                        r()
                    }, 3e3)) : setTimeout(function() {
                        r()
                    }, 3e3), messenger.send(o.data)
                },
                s = function() {
                    messenger.send({
                        status: "faile",
                ...
                l = e.fpurl,
                u = e.from;
            (c = this).get(e, function(e) {
                function t(e) {
                    e = new RegExp("(^|&)" + e + "=([^&]*)(&|$)"), e = g.location.search.substr(1).match(e);
                    return null != e ? unescape(e[2]) : null
                }
                console.log("dataObj", e), e.xxzl_cid = t("cid"), e.sessionid = t("token"), e.xxzl_deviceid = t("deviceid"), console.log("上报的所有字段", e);
                ...
                r = (r = CryptoJS.AES.encrypt(a, n, {
                    mode: CryptoJS.mode.ECB,
                    padding: CryptoJS.pad.Pkcs7
                })).ciphertext.toString(), c.postData("xxzlfp", r, l, u, "post", o, s)
            })
        },
        postData: function(e, t, n, a, r, i, o) {
            var c = null;
            (c = g.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP")).open(r, n, !0), "post" === r ? c.setRequestHeader("Content-Type", "text/html") : r = "get", c.send(t), c.onreadystatechange = function() {
                4 == c.readyState && (200 == c.status ? i && i(c.responseText) : o && o())
            }
        },
        hand_save_all: function(e, t) {
            this.setCookie(e, t), g.localStorage[e] = t, g.sessionStorage[e] = t
        },
        pollingEvent: function() {
            var r = this;
            r.pollingTimer = setInterval(function() {
                var e, t, n, a;
                g.localStorage && (e = r.getCookie("xxzl_cid"), t = g.localStorage.xxzl_cid, g.XXZL_CID_WRITE = g.XXZL_CID_WRITE && "-1" != g.XXZL_CID_WRITE ? g.XXZL_CID_WRITE : e, n = r.getCookie("xzuid"), a = g.localStorage.xzuid, g.XXZL_UUID_WRITE = g.XXZL_UUID_WRITE && "-1" != g.XXZL_UUID_WRITE ? g.XXZL_UUID_WRITE : n, "sogou" == browserTypeReal ? ("-1" != XXZL_CID_WRITE && XXZL_CID_WRITE && (e && "-1" != e && t || r.hand_save_all("xxzl_cid", XXZL_CID_WRITE)), "-1" != XXZL_UUID_WRITE && XXZL_UUID_WRITE && (n && "-1" != n && a || r.hand_save_all("xzuid", XXZL_UUID_WRITE))) : ("-1" != XXZL_CID_WRITE && XXZL_CID_WRITE && (e && "-1" != e && t || _0xd7e6c.set("xxzl_cid", XXZL_CID_WRITE)), "-1" != XXZL_UUID_WRITE && XXZL_UUID_WRITE && (n && "-1" != n && a || _0xd7e6c.set("xzuid", XXZL_UUID_WRITE))))
            }, 1500)
        },
        $ajax: function(e) {
            var t = this;
            ...
            r && r.parentNode.removeChild(r), g[n] = function(e) {
        ...
        get: function(o, c) {
            var s = this,
                ...
                e = [];
            (l = []).push({
                id58: s.getCookie("id58") + "|" + s.getCookie("58cooper") + "|" + s.getCookie("GanjiUserInfo") + "|" + s.getCookie("xxzl_deviceid") + "|" + s.getCookie("PPU")
            });
            ...
            function a(a) {
                l.push({
                    ...
                    session_storage: s.sessionStorageKey()
                }), l.push({
                    local_storage: s.localStorageKey()
                }), l.push({
                    indexed_db: s.indexedDbKey()
                }), l.push({
                    add_behavior: s.addBehaviorKey()
                }), l.push({
                    open_database: s.openDatabaseKey()
                }), l.push({
                    cpu: s.cpuClassKey()
                }), l.push({
                    platform: s.platformKey()
                }), l.push({
                    treed: s.doNotTrackKey()
                }), l.push({
                    touch: s.touchSupportKey()
                }), l.push({
                    adblock: s.adBlockKey()
                }), l.push({
                    change_lang: s.hasLiedLanguagesKey()
                }), l.push({
                    change_size: s.hasLiedResolutionKey()
                }), l.push({
                    change_os: s.hasLiedOsKey()
                }), l.push({
                    change_browser: s.hasLiedBrowserKey()
                });
                var r = s.pluginsKey(),
                    i = s.getFontsKey();
                l.push({
                    ...
                    screen_top: g.screenTop || "-1"
                }), l.push({
                    screen_y: g.screenY || "-1"
                }), l.push({
                    screen_left: g.screenLeft || "-1"
                }), l.push({
                    avail_width: g.screen.availWidth || "-1"
                }), l.push({
                    avail_height: g.screen.availHeight || "-1"
                }), l.push({
                    avail_top: g.screen.availTop || "-1"
                }), l.push({
                    avail_left: g.screen.availLeft || "-1"
                }), l.push({
                    inner_height: g.innerHeight || "-1"
                }), l.push({
                    inner_width: g.innerWidth || "-1"
                }), l.push({
                    device_pixel_ratio: g.devicePixelRatio || "-1"
                }), l.push({
                    pixel_depth: g.screen.pixelDepth || "-1"
                }), l.push({
                    build_id: navigator.buildID || "-1"
                }), l.push({
                    product_sub: navigator.productSub || "-1"
                }), l.push({
                    product: navigator.product || "-1"
                }), l.push({
                    max_touch_points: navigator.maxTouchPoints || "-1"
                }), l.push({
                    device_memory: navigator.deviceMemory || "-1"
                }), l.push({
                    user_language: navigator.userLanguage || "-1"
                }), l.push({
                    browser_language: navigator.browserLanguage || "-1"
                }), l.push({
                    system_language: navigator.systemLanguage || "-1"
                }), l.push({
                    window_api_num: Object.getOwnPropertyNames(g) ? Object.getOwnPropertyNames(g).length : "-1"
                }), l.push({
                    is_canvas_supported: s.isCanvasSupported()
                }), l.push({
                    canvas_arr: s.canvasArr()
                }), l.push({
                    infinity: g.Infinity || "-1"
                }), l.push({
                    ...
                    cookie_enabled: navigator.cookieEnabled || "-1"
                }), l.push({
                    scroll_restoration: history.scrollRestoration || "-1"
                }), l.push({
                    is_secure_context: g.isSecureContext || "-1"
                });
                var t = function() {
                        l.push({
                            ...
                            web_driver: navigator.webdriver || "-1"
                        }), l.push({
                            hardware_concurrency: navigator.hardwareConcurrency || "-1"
                        }), r && "-1" != r ? l.push({
                            plugin_hash: s.hashcode(r)
                        }) : l.push({
                            plugin_hash: "-1"
                        }), i && "-1" != i ? l.push({
                            font_hash: s.hashcode(i)
                        }) : l.push({
                            font_hash: "-1"
                        }), s.getBrowserKey(l), l.push({
                            languages: navigator.languages ? navigator.languages.join(",") : "-1"
                        }), l.push({
                            navigator_keys: s.navigatorKey()
                        }), console.log("上传的uuid，", a), l.push({
                            uuid: a
                        });
                        for (var e = {}, t = 0; t < l.length; t++)
                            for (var n in l[t]) e[n] = l[t][n];
                        c(e)
                    },
                    n = function(e) {
                        l.push({
                            font_list: e
                        }), s.getInnerIp(function(e) {
                            e = e, l.push({
                                lan_ip: e
                            }), s.getbatteryInfos(l, function() {
                                s.getwebrtcids(l, t)
                            })
                        })
                    };
        ...
        monitor: function(t, n) {
            var a = this;
            n && (a.monit && clearInterval(a.monit), a.monit = setInterval(function() {
                var e = a.getCookie(t);
        ...
        getFlashFontsKey: function(r, i) {
            ...
            if (!n() || (e = n()) && e < 59 && (t = !0), t || "QQ" == browserTypeReal || "360" == browserTypeReal || "360old" == browserTypeReal || "sogou" == browserTypeReal || "IE" == browserTypeReal) i("-1");
            else {
                var o, a, c = this;
                try {
                    c.flashFlag = !1, !u && swfobject ? (o = function() {
                        ...
                        swfobject.embedSWF(n, "trackerFp", "1", "1", "9.0.0", !1, a, {
                            ...
                            0 == c.flashFlag && (c.flashFlag = !0, g[e] = function() {}, i("-1"))
                        }, 200)
                    }(function(e) {
        ...
        hasLiedOsKey: function() {
            var e = navigator.userAgent.toLowerCase(),
                ...
                e = "ontouchstart" in g || 0 < navigator.maxTouchPoints || 0 < navigator.msMaxTouchPoints ? 1 : 0;
        ...
        getAudioKey: function(r) {
            ...
            if (u) i || (i = !0, r("-1|-1"));
                ...
                var e, t, o, c, s = {};
                if ((g.AudioContext || g.webkitAudioContext) === l) s.pxi_hash = -1, s.pxi_output = -1, i = !0, r(s.pxi_hash + "|" + s.pxi_output);
                else try {
                    (e = new(g.OfflineAudioContext || g.webkitOfflineAudioContext)(1, 44100, 44100)) || (s.pxi_output = 0), (t = e.createOscillator()).type = "triangle", t.frequency.value = 1e4, (o = e.createDynamicsCompressor()).threshold && (o.threshold.value = -50), o.knee && (o.knee.value = 40), o.ratio && (o.ratio.value = 12), o.reduction && (o.reduction.value = -20), o.attack && (o.attack.value = 0), o.release && (o.release.value = .25), t.connect(o), o.connect(e.destination), t.start(0), e.startRendering(), e.oncomplete = function(e) {
                        s.pxi_output = 0;
            ...
            try {
                ...
                if (!t) {
                    ...
                    try {
                        ...
                        g.RTCPeerConnection = o.RTCPeerConnection, g.mozRTCPeerConnection = o.mozRTCPeerConnection, g.webkitRTCPeerConnection = o.webkitRTCPeerConnection, t = g.RTCPeerConnection || g.mozRTCPeerConnection || g.webkitRTCPeerConnection
                    } catch (e) {
                        if (!r) return r = !0, void a("-1")
                    }
                }
                try {
                    var c = new t(g.webkitRTCPeerConnection ? {
                        iceServers: [{
